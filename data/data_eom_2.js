...
const data = {
    ...
    "index_2":{
        ...
        "paragraph_1":[
            {"text": `
                ...
                <p>
                Статор (1) – гладкое кольцо, внутри которого по диаметру расположены лопатки (5) уникальной формы. Концы лопаток соединены ободом (3). Ротор – кольцо (2) с лопатками (6), изогнутыми в противоположную сторону лопаткам статора. Концы лопаток ротора соединены ободом (4). Статор и ротор между собой соединены с зазором, чтобы свободно вращаться ротору вокруг статора.
                </p>
        ...
        "paragraph_2":[
            ...
            {"text": `
                     ...
                     <p>
                        <b>1 – </b>статор <br>
                        <b>2 – </b>ступень ротора <br>
                        <b>3 – </b>наружный и внутренний ободы <br>
                        <b>4 – </b>пята <br>
                        <b>5 – </b>лопатка статора <br>
                        <b>6 – </b>лопатка ротора <br>
                      </p>`}
        ],
        "paragraph_3":[
            {"text": `
    ...
    "index_3":{
        "subtitle": "Обозначьте элементы турбобура на рисунке.",
        "step_of_popup": "Обозначьте элементы турбобура на рисунке",
        "test": [{
            "type": 3
        }, {
            "image": true,
    ...
    "index_4":{
        ...
        "paragraph_3":[
            {"image": true, "image_path": "./content/page_content/img4_02.png", "img_sign": " ", "left_img": true, "unique": true},
            {"text": `
                     ...
                     <p> 
                       ...
                       <b> 4 </b>– шпиндель; <br>
                       <b> 5 </b>– вал; <br>
                       <b> 6 </b>– переводник вала; <br>
                       <b> 7 </b>– переводник верхний; <br>
                       <b> 8 </b>–  корпус; <br>
                       <b> 9 </b>– контргайка; <br>
                       <b> 10 </b>– гайка роторная; <br>
                       <b> 11 </b>– опора средняя <br>
                      </p>`}
        ],
        "paragraph_4": [
    ...
    "index_9":{
        ...
        "test": [{
            ...
            "answers": ["вал шпинделя", "шпиндель", "переводник", "шарнирное соединение", "ротор", "статор", "планетарный механизм"]
        }]
    },
    "index_10":{
        ...
        "paragraph_1":[
            {"text": `
                <p> 
                При бурении роторным способом параметры режима бурения – осевая нагрузка на долото (Р<sub>д</sub>), проходка на долото (h) и подача промывочного раствора (Q) – не влияют друг на друга. В бурении забойными двигателями осевая нагрузка (Р<sub>д</sub>) на долото зависит от подачи промывочного раствора (Q). В турбинном бурении обороты долота (n) и осевая нагрузка (Р<sub>д</sub>) будут зависеть от величины подачи промывочного раствора (Q). Скорость вращения долота (v) не изменяется при бурении электробуром, но по силе тока (I) судят о работе долота и так создают оптимальные осевые нагрузки на долото (Р<sub>д</sub>).
                <br>
        ...
        "paragraph_2":[
            {"text": false},
            {"image": true, "image_path": "./content/page_content/img10_01.png", "img_sign": " ", "left_img": true}  
        ],
    },
    "index_11":{
    ...
    "index_12":{
        "subtitle": "Изучите работоспособность турбины в зависимости от подачи промывочной жидкости.",
        "step_of_popup": "Изучите работоспособность турбины в зависимости от подачи промывочной жидкости",
        "paragraph_1":[
            {"text": `
                <p> 
    ...
    "index_13":{
        "subtitle": "Установите зависимость между регулируемым параметром при турбинном бурении и подачей промывочной жидкости.",
        "step_of_popup": "Установите зависимость между регулируемым параметром при турбинном бурении и подачей промывочной жидкости",
        "test":[
            {"type": 9},
            {"description": " "},
            {"definitions": [
    ...
    "index_14":{
        "subtitle": "Изучите зависимость крутящего момента М турбины от частоты вращения ротора n.",
        "step_of_popup": "Изучите зависимость крутящего момента М турбины от частоты вращения ротора n",
        "paragraph_1":[
            ...
            {"text": `
                ...
                <p><b class='blue_header'>Описание:</b> крутящий момент уменьшается, а частота вращения вала растёт,  достигает максимального значения – отрезок Оn<sub>х</sub>. Скорость вращения вала будет меняться и вызывать изменения, кроме момента, и КПД, и мощности.
                </p>
                `}
        ],
    },
    "index_15":{
        "subtitle": "Установите соответствие между режимом работы турбины и точкой на графике.",
        "step_of_popup": "Установите соответствие между режимом работы турбины и точкой на графике",
        "test": [{
            "type": 3
        }, {
            "image": true,
        ...
        "paragraph_1": [
            ...
            {"text": `
                ...
                <p>После разборки и подробного осмотра забойного двигателя в ремонтном цехе, определяется окончательная причина отказа.
                </p>
                `}
        ],
        "paragraph_2": [
        ...
        "paragraph_4": [
            ...
            {"text": `
                ...
                <p>После завершения эксплуатации на буровой забойного двигателя вывозят на ремонт.
                </p>
                `}
        ],
    },
        "index_17": {
        "subtitle": "Какие факторы необходимо контролировать для обеспечения нормативного времени работы забойного двигателя. Выберите несколько правильных ответов.",
        "step_of_popup": "Какие факторы необходимо контролировать для обеспечения нормативного времени работы забойного двигателя",
        "test":[
            {"type": 1},
            {"answers": [
                "утечки в бурильных трубах",
                "качество  и свойства бурового раствора",
                "частоту вращения долота",
                "износ долота"
            ]},
            {"correct_answer": [0, 1]},
            {"image": false, "image_path": "./content/tests_content/01_01.png"}
        ],
    },
        "index_18": {
        "subtitle": "Изучите условия транспортирования и хранения забойных двигателей.",
        "step_of_popup": "Изучите условия транспортирования и хранения забойных двигателей",
        "paragraph_1": [
            {"text": `<p>
                    Забойные двигатели на буровую перемещают в разборе на транспорте, который специально предназначается для этой цели. Это турбовозы. 
                    </p> `}
        ],
        "paragraph_2": [
            {"image": true, "image_path": "./content/page_content/img18_01.png", "img_sign": "Колпаки-заглушки резьбы", "left_img": true},
            {"text": `
                     <p>Все резьбовые поверхности забойных двигателей  предварительно смазывают и предохраняют колпаками, глушат.
                     </p>
                     <p><b class='blue_header'> Требования по разгрузке забойных двигателей: </b> 
                    <ol class='ul_custom'>
                        <li>Осторожно, внимательно;</li>
                        <li>Без ударов;</li>
                        <li>Применять кран или лебёдку.</li>
                    </ol>
                     </p>
                    `}
        ...
        "paragraph_3": [
            {"image": true, "image_path": "./content/page_content/img18_02.png", "img_sign": "Противооткатные стойки", "left_img": true, "unique": true},
            {"text": `
                     
                     <p><b class='blue_header'>Требования по хранению чистых забойных двигателей: </b> 
                    <ol class='ul_custom'>
                        <li>В определённом месте;</li>
                        <li>На специальных стеллажах с противооткатными стойками;</li>
                        <li>Каждая секция стеллажа подписана и содержит следующую информацию:
                            <ol>
                             <li>Типоразмер;</li>
                             <li>Инвентарный номер;</li>
                             <li>Дата завоза;</li>
                             <li>Наработка в часах;</li>
                             <li>Наработка в метрах.</li>
                            </ol>
                        </li>
                    </ol>
                     </p>
        ...
        "index_19": {
        "subtitle": "Какую информацию должна содержать бирка на стеллаже, где хранятся забойные двигатели. Выберите несколько правильных ответов.",
        "step_of_popup": "Какую информацию должна содержать бирка на стеллаже, где хранятся забойные двигатели",
        "test":[
            {"type": 1},
            {"answers": [
                "Типоразмер",
                "Инвентарный номер",
                "Дата завоза",
                "Наработка в часах и метрах",
                "Параметры присоединительных резьбовых отверстий"
            ]},
