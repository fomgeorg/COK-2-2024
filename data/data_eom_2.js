...
const data = {
    ...
    "index_15":{
        ...
        "paragraph_3": [
            {"image": true, "image_path": "./content/page_content/img18_02.png", "img_sign": "Противооткатные стойки", "left_img": true},
            {"text": `
        ...
        "index_19": {
        "subtitle": "Выберите несколько правильных ответов. Какую информацию должна содержать бирка на стеллаже, где хранятся забойные двигатели:",
