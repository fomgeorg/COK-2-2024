window.dataLoaded = false;
    ...
    const data = {
        ...
        "index_4":{
            ...
            "paragraph_1":[
                {"image": true, "image_path": "./content/page_content/img5_1.png", "img_sign": "Рисунок 5. Общий вид турбобура", "left_img": true, "unique": true},
                {"text": `
                    <p>
            ...
            "paragraph_2":[
                {"image": true, "image_path": "./content/page_content/img5_2.png", "img_sign": "Рисунок 6. Ступень турбины двигателя", "unique": true},
                {"text": `
                    <ol class='ul_custom'>
                        <li>вал</li>
                        <li>корпус</li>
